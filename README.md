...
**DevJima**は、日本語と英語に対応したバイリンガルの開発者向けブログ・コミュニティプラットフォームです。

江戸時代、長崎の出島（Dejima）は日本と外国をつなぐ唯一の窓口でした。
DevJimaはその精神を受け継ぎ、日本の開発者が世界へ、世界の開発者が日本へ、
技術・キャリア・文化の知見を共有できる場を目指しています。

### 作成背景

Spring BootとNext.jsの学習成果を実践的なプロジェクトとして形にするために開発しました。
また、日本でこれから業界に入る外国人開発者として、日本のIT文化と海外の視点を橋渡しするようなプラットフォームの必要性を感じたことも動機のひとつです。

## 2. デモ

### ランディングページ・ユーザー登録
![登録・ログイン](docs/images/landing.register.gif)

### ログイン・投稿
![投稿・ログイン](docs/images/login.post.gif)

### タグ・キーワード検索
![検索・フィルター](docs/images/tags.search.gif)

### 翻訳機能
![翻訳](docs/images/translate.gif)

### コメント・返信
![コメント](docs/images/comment.reply.gif)

### プロフィール編集
![プロフィール編集](docs/images/profile.edit.gif)

### 投稿・コメント削除
![削除](docs/images/delete.gif)
...
### ER図
![ER図](docs/images/supabase.er.diagram.png)
